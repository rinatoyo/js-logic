...
console.log(isGreaterThan(20,19));
...
console.log('bigBird:', bigBird('owl'));
...
console.log('dirty30:', dirty30(10, 7, 15));
...
console.log('evenStevens:', evenStevens(26));
...
console.log('daClub:', daClub(25, 26));
...
console.log('moneyTrain:', moneyTrain(200));
